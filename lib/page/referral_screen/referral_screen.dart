...
import 'package:rugbyrider/controller/referral_controller.dart';
...
class _ReferralScreenState extends State<ReferralScreen> {
  ...
  Future<void> share(ReferralController referralController) async {
    ...
    await FlutterShare.share(
      title: 'RugbyRudes',
      text:
          'Hey there, thanks for choosing RugbyRides. Hope you love it. If you do, share it with your friends and get rewards! using code ${referralController.referralCode.toString()} and get ${Constant().amountShow(amount: referralController.referralAmount.toString())} when ride completed',
    );
  }
}
