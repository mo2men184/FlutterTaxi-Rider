...
import 'package:rugbyrider/page/auth_screens/login_screen.dart';
import 'package:rugbyrider/page/contact_us/contact_us_screen.dart';
import 'package:rugbyrider/page/coupon_code/coupon_code_screen.dart';
import 'package:rugbyrider/page/dash_board.dart';
import 'package:rugbyrider/page/favotite_ride_screens/favorite_ride_screen.dart';
import 'package:rugbyrider/page/localization_screens/localization_screen.dart';
import 'package:rugbyrider/page/my_profile/my_profile_screen.dart';
import 'package:rugbyrider/page/new_ride_screens/new_ride_screen.dart';
import 'package:rugbyrider/page/privacy_policy/privacy_policy_screen.dart';
import 'package:rugbyrider/page/referral_screen/referral_screen.dart';
import 'package:rugbyrider/page/rent_vehicle_screens/rent_vehicle_screen.dart';
import 'package:rugbyrider/page/rented_vehicle.dart';
import 'package:rugbyrider/page/terms_service/terms_of_service_screen.dart';
import 'package:rugbyrider/page/wallet/wallet_screen.dart';
...
class DashBoardController extends GetxController {
  ...
  onSelectItem(int index) {
    if (index == 13) {
      LaunchReview.launch(
        androidAppId: "com.rugbyrides.rider",
        iOSAppId: "com.rugbyrides.rider",
      );
    } else if (index == 14) {
